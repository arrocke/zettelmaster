...
export function findNodeRecursive(node: Node, fn: ((node: Node) => boolean)): Node | undefined {
...
export function findMarkRecursive(node: Node, fn: ((node: Mark) => boolean)): Mark | undefined {
	if ('marks' in node) {
